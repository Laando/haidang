jQuery(function($){
	...
	slzexploore_fn.registerPage = function(){
		if ( $("#register_member").length ) {
			...
			var msg_fullname_required = $('input[name=regfullname]').data('validation-error-msg-required');
			var msg_phone_required = $('input[name=regphone]').data('validation-error-msg-required');
			var msg_phone_number = $('input[name=regphone]').data('validation-error-msg-number');
			var msg_phone_minlength = $('input[name=regphone]').data('validation-error-msg-minlength');
			var msg_phone_maxlength = $('input[name=regphone]').data('validation-error-msg-maxlength');
			...
			var msg_repassword_required = $('input[name=password_confirmation]').data('validation-error-msg-required');
			var msg_repassword_minlength = $('input[name=password_confirmation]').data('validation-error-msg-minlength');
			var msg_repassword_equalTo = $('input[name=password_confirmation]').data('validation-error-msg-equalTo');
			...
			formRegisterMember.validate({
				...
				messages: {
					regfullname : {
						required : msg_fullname_required
					} ,
					regphone: {
						required: msg_phone_required,
						number : msg_phone_number ,
						minlength: msg_phone_minlength ,
						maxlength: msg_phone_maxlength
					},
					email: {
	...
	/* JS user page */
	slzexploore_fn.userPage = function(){
		if ( $("#user_member").length ) {
			var formRegisterMember = $("#user_member");
			var msg_fullname_required = $('input[name=fullname]').data('validation-error-msg-required');
			formRegisterMember.validate({
				rules: {
					regfullname: {
						required: true
