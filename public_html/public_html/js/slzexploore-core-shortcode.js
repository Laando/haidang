	...
	$.slzexploore_nstSlider = function() {
		$('.nstSlider').nstSlider({
			...
			"value_changed_callback": function(cause, leftValue, rightValue) {
				...
				departTime.text(numbertomoney(leftValue+''));
				arriveTime.text(numbertomoney(rightValue+''));
				...
				var nodeslide = $(this).parent().find('.sliderValue');
				$(nodeslide).val(leftValue + ',' + rightValue);
                $(nodeslide).mouseup(function() {
                    $(nodeslide).trigger('change');
                });
			},
