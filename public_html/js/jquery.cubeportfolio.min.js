    ...
    function(a, b) {
        ...
        c.prototype.click = function() {
            ...
            b.loadMore.on("click.cbp", function(d) {
                var e = a(this);
                var datafilter = $('.cbp-filter-item.cbp-filter-item-active').attr('data-filter');
                var ishomepage = $('#myCarousel').length;
                if(datafilter=='.TOUR-NOEL'||datafilter=='.TOUR-TET-DUONG-LICH '||datafilter=='.TOUR-TET-NGUYEN-DAN')
                {
                    if(checktype != datafilter)  {
                        c = 0;
                        $(e).removeClass('cbp-l-loadMore-stop');
                    }
                    console.log($.inArray(checktype,lasttype));
                    if($.inArray(checktype,lasttype)!==-1){
                        $(e).addClass('cbp-l-loadMore-stop');
                    } else {
                        lasttype.push(checktype);
                    }
                    checktype = datafilter;
                }
