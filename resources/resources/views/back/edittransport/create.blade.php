...
@section('main')
 ...
 <!-- Entête de page -->
  @include('back.partials.entete', ['title' => trans('back/edittransports.dashboard'), 'icone' => 'send', 'fil' => link_to('edittransport', trans('back/edittransports.edittransports')) . ' / ' . trans('back/edittransports.creation')])
	...
	<div class="col-sm-12">
		{!! Form::open(['url' => 'edittransport', 'method' => 'post', 'class' => 'form-horizontal panel']) !!}
            ...
            {!! Form::selection('multiroute', $select, null, 'Liên tuyến') !!}
            {!! Form::selection('sourcepoint', $selectsource, null, 'Khởi hành') !!}
            {!! Form::selection('destinationpoint', $selectdestination, null, 'Điểm đến') !!}
			{!! Form::submit('Tạo mới') !!}
		{!! Form::close() !!}
	</div>
