...
@section('main')
  ...
  <div class="col-md-12">
      <div class="col-md-12 col-xs-12">
          {!! Form::text('search',  Request::get('search')!=''?Request::get('search'):null , array('class'=>'form-control','placeholder'=>'Tìm kiếm khách hàng (Tên / MemberCard )')) !!}
      </div>
  </div>
  ...
  {!! Form::close() !!}
  <div class="col-md-12"><a href="{!! asset('staff/printCustomerList') !!}">Xuất danh sách khách hàng</a></div>
  <div class="clearfix"></div>
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th>{{ trans('back/users.name') }}/{{ trans('back/users.phone') }}</th>
