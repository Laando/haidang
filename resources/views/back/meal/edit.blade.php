...
@section('main')
    ...
    <div class="col-sm-12">
        {!! Form::model($meal, ['route' => ['meal.update', $meal->id], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}
        ...
        {!! Form::selection('destinationpoint', $selectdestination, $meal->destination_point, trans('back/meals.destinationpoint')) !!}
