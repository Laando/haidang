...
@section('main')
    ...
    <!-- Entête de page -->
    @include('back.partials.entete', ['title' => trans('back/addingcates.dashboard'), 'icone' => 'send', 'fil' => link_to('addingcate', trans('back/addingcates.addingcates')) . ' / ' . trans('back/addingcates.creation')])

    <div class="col-sm-12">
        {!! Form::model($addingcate, ['route' => ['addingcate.update', $addingcate->id], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}
        {!! Form::control('text', 0, 'title', $errors, trans('back/addingcates.title')) !!}
        {!! Form::control('text', 0, 'seat', $errors, trans('back/addingcates.description')) !!}
        Bắt buộc <input value="1" type="checkbox" name="isForced" {!! $addingcate->isForced==1?'checked="checked"':''!!}/>
