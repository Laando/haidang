...
@section('main')
        ...
        <div class="container">
            <div class="subscribe-email-wrapper">
                <div class="subscribe-email-left">
                    <p class="subscribe-email-title">Xin chào!<span class="logo-text"> {{ $user->fullname }}</span></p>
                    <p class="subscribe-email-text">Từ trang tổng quan tài khoản của bạn, bạn có thể xem các đơn đặt hàng gần đây của bạn, quản lý các địa chỉ vận chuyển và thanh toán của bạn và chỉnh sửa mật khẩu và chi tiết tài khoản của bạn.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section section-padding page-detail padding-top padding-bottom">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-12 padding-col-right">
                    <div class="content-team-detail">
                        <div class="content-expert">
                            <ul class="list-unstyled about-us-list">
                                <li><p class="text"><a href="">Thông tin chi tiết</a></p></li>
                                <li><p class="text"><a href="">Đổi mật khẩu</a></p></li>
                                <li><p class="text"><a href="">Lịch sử đơn hàng</a></p></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 thongtin-user">
                    <ul class="nav nav-tabs">
                        ...
                        <li {!! $page==4?'class="active"':'' !!} id="link-eventanh"><a href="#eventanh" data-toggle="tab">ĐĂNG BÀI DỰ THI ẢNH</a></li>
                    </ul>
                    <!-- Tabs -->
                    <div class="tab-v1">
