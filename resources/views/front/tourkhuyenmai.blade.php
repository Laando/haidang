...
<div class="campaign-black-friday-18">
                ...
                <div class="content-banner clearfix">
                  <div class="top-banner hidden-xs">
                    <img
                      src="{{ asset('')}}images/5bf51faa3b48e-1180x450.jpg"
                    />
                  </div>
                  <div class="top-banner visible-xs">
                    <img
                      src="{{ asset('')}}images/5bf51faa3b31b-750x390.jpg"
                    />
                  </div>
                </div>
                <div class="container">
                  <div class="row">
                    ...
                    <script>
                        ...
                        var x = setInterval(function() {
                            ...
                            if (distance<0) {
                                document.getElementById("titlegiovang").innerHTML =  "GIỜ VÀNG SẼ KẾT THÚC SAU";
                                var now = new Date();
                                ...
                                if (distance < 0) {
                                    document.getElementById("titlegiovang").innerHTML =  "GIỜ VÀNG ĐÃ KẾT THÚC";
                                    distance=0;
                                    if(!document.getElementById("block-main-hot").classList.add('contains')){
                                      document.getElementById("block-main-hot").classList.add('hide');
                                    }
                      ...
                      <div class="item-list-product">
                        <div class="product-hot " id="">
                                ...
                                <div class="row products" id="block-main-hot">
                                    ...
                                    <div class="col-md-4 product-wrapper " id="product-352578-wrapper" data-id="352578" data-show="1" data-text="" data-campaign-time="0">
                                        <div class="product product-kind-1" id="product-352578"  data-toggle="box-link" data-target="_blank">
                                            <div class="product__image">
                                                <a target="_blank"href="{{asset($startdate->tour->slug)}}"title="{{$startdate->tour->title}}">
                                                    ...
                                                    <span class="icon-hot hot">ĐANG GIẢM</span>
                                      ...
                                      <div class="product__info">
                                        <div class="product__price _product_price" itemprop="offers" itemscope=""  >
                                          ...
                                          <span class="price">
                                            <span class="price__value" itemprop="price"  >{{number_format($startdate->tour->adultprice - $startdate->tour->adultprice*$startdate->percent/100)}}
                                            </span>
                                            <span class="price__symbol">đ</span>
                                            <span class="price__discount">-{{$startdate->percent}}%</span>
                                        </span>
                                    </div>
                                    <div class="product__price product__price--list-price _product_price_old " style="display: inline-block;">
                                      <span class="price price--list-price">
                                        <span class="price__value"> {{number_format($startdate->tour->adultprice)}}</span> 
                          ...
                          <div class="box-count">
                              ...
                              <button type="button" class="btn btn-success btn-sm  bt-mua-ngay" data-toggle="modal" data-target="#myModal">MUA NGAY</button>
                          </div>
                      </div>
                  </div>
              </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <p>VÉ GIỜ VÀNG CHỈ CÒN: <b>02 VÉ</b> </p>
          ...
          <p>Vui lòng nhập Số lượng: <input class="tb-input count" min="1" max="100" type="number" value="1" name="adults" id="booking-adults-number" onchange="calculateTotal()"></p>
        <p>Sau khi quý khách đăng ký, nhân viên chúng tôi sẽ liên hệ tư vấn và xác nhận đơn hàng của quý khách. Quý khách sẽ được giữ chổ trong vòng 120 phút để thanh toán. Sau 120 phút đơn hàng sẽ tự đông huỷ.<br>
