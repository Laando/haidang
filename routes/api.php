...
Route::post('test', 'API\FirebaseController@testFirebase');
Route::group(['middleware' => 'auth:api'], function () {
    //User
    Route::post('UpdateLastLogin', 'API\UserController@updateLastLogin');
    Route::post('LoadAccountant', 'API\UserController@loadAccountant');
    Route::post('LoadCustomer', 'API\UserController@loadCustomer');
    Route::post('InsertCustomer', 'API\UserController@insertCustomer');
    Route::post('UpdateCustomer', 'API\UserController@updateCustomer');
    Route::post('DeleteCustomer', 'API\UserController@deleteCustomer');
    Route::post('LoadCustomerToGrid', 'API\UserController@loadCustomerToGrid');
    Route::post('EnableCustomer', 'API\UserController@enableCustomer');
